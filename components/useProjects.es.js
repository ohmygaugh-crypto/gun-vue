...
function useProjects() {
  ...
  const db = gun2.user(currentRoom.pub).get("projects");
  db.map().on((d, k) => {
    console.log(k, d);
    projects[k] = d;
  });
...
export { downloadFeed, formatDate, langParts, languages, logEvent, newWorker, sortByDate$1 as sortByDate, uploadFeed, useLog, usePosts, useProjects };
