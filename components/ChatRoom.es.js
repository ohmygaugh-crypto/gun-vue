import { openBlock, createElementBlock, createBaseVNode, withDirectives, vModelText, withKeys, withModifiers, createVNode, createCommentVNode, ref, onMounted, toRef, reactive, computed, watchEffect, watch, nextTick, useCssVars, unref, forceGraph, useBrowserLocation, useClipboard, useShare, toDisplayString, normalizeStyle, renderSlot, createTextVNode, withCtx, Fragment, renderList, createBlock, TransitionGroup, useMediaQuery, onClickOutside } from "./vendor.es.js";
import { useUser, useGun, safeHash, useAccount, useDictRecordsBy, useDictLangs, dictLang, useDictAuthors, useColor, useDictRecordsFor, dictRecord, selectedUser, useWord, letterFilter, useDefs, useWords, currentRoom, user, gun } from "./useDraw.es.js";
import { useChat } from "./useChat.es.js";
import { useBackground } from "./useBackground.es.js";
import { _export_sfc } from "./plugin-vue_export-helper.es.js";
import "./AccountAvatar.es.js";
import __unplugin_components_0$3 from "./AccountBadge.es.js";
import "./AccountHome.es.js";
import "./AccountSelect.es.js";
import { usePost, addPost, usePostTimestamp } from "./useZip.es.js";
...
import "./times.es.js";
import "./plus.es.js";
import "./useGuests.es.js";
import "./useFile.es.js";
import "./check.es.js";
import "./pen.es.js";
import "./exit-outline.es.js";
import "./tools.es.js";
import "./useGifts.es.js";
import "./useSpace.es.js";
import "./qrcode.es.js";
import "./lock.es.js";
import "./eye.es.js";
const _hoisted_1$4 = {
...
var __unplugin_components_0$2 = { name: "la-comment-dots", render: render$4 };
const _hoisted_1$3 = {
  key: 0,
  class: "flex gap-2"
};
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_la_comment_dots = __unplugin_components_0$2;
...
var __unplugin_components_1 = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", render$3], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/chat/ChatInput.vue"]]);
const _sfc_main$v = {
  __name: "AccountStars",
  props: {
  ...
  setup(__props, { expose, emit }) {
    ...
    const gun2 = useGun();
    gun2.user(props.pub).get("feeds").map().once(function(list, tag) {
      this.map().on((d, k) => {
        var _a;
        if (!d) {
    ...
    const __returned__ = { props, emit, posts, gun: gun2, reactive, useGun, safeHash, usePost };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
};
_sfc_main$v.__file = "src/account/AccountStars.vue";
const _sfc_main$u = {
  __name: "ChatPrivate",
  props: {
    pub: String
...
_sfc_main$i.__file = "src/form/FormLink.vue";
...
_sfc_main$f.__file = "src/post/PostForm.vue";
const _sfc_main$e = {
  __name: "PostGraph",
  emits: ["post"],
  setup(__props, { expose, emit }) {
...
_sfc_main$e.__file = "src/post/PostGraph.vue";
...
_sfc_main$d.__file = "src/post/PostLine.vue";
const _sfc_main$c = {
  __name: "UtilShare",
  setup(__props, { expose }) {
    expose();
...
_sfc_main$c.__file = "src/util/UtilShare.vue";
const _sfc_main$b = {
  __name: "PostList",
  props: {
    tag: { type: String },
...
_sfc_main$b.__file = "src/post/PostList.vue";
...
_sfc_main$a.__file = "src/post/action/PostActionUpdate.vue";
const _sfc_main$9 = {
  __name: "PostPage",
  props: {
    tag: { type: String, default: "" },
...
_sfc_main$9.__file = "src/post/PostPage.vue";
const _sfc_main$8 = {
...
_sfc_main$8.__file = "src/post/action/PostActionStar.vue";
const _sfc_main$7 = {
...
_sfc_main$7.__file = "src/post/action/PostActionBan.vue";
const _sfc_main$6 = {};
_sfc_main$6.__file = "src/room/RoomProfile.vue";
const _sfc_main$5 = {
  __name: "UiModal",
  props: {
    open: { default: false }
...
_sfc_main$5.__file = "src/ui/UiModal.vue";
const _sfc_main$4 = {
  __name: "UtilTools",
  setup(__props, { expose }) {
    expose();
...
_sfc_main$4.__file = "src/util/UtilTools.vue";
...
_sfc_main$3.__file = "src/util/UtilTree.vue";
const _hoisted_1$2 = { class: "ml-2 text-sm opacity-20 hover_opacity-80 transition cursor-default text-light-200" };
const _hoisted_2$1 = /* @__PURE__ */ createBaseVNode("div", { class: "flex-1" }, null, -1);
const _hoisted_3$1 = { class: "ml-2 text-sm opacity-20 hover_opacity-80 transition cursor-default text-light-200" };
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  var _a, _b;
  const _component_account_badge = __unplugin_components_0$3;
  return openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("div", {
      ...
      createBaseVNode("div", _hoisted_1$2, toDisplayString((_a = $setup.dateTime) == null ? void 0 : _a.time), 1),
      _hoisted_2$1,
      createBaseVNode("div", _hoisted_3$1, toDisplayString((_b = $setup.dateTime) == null ? void 0 : _b.date), 1)
    ], 4),
    createBaseVNode("div", {
...
_sfc_main$2.__file = "src/chat/ChatMessage.vue";
var __unplugin_components_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", render$2], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/chat/ChatMessage.vue"]]);
const _hoisted_1$1 = {
  class: "flex flex-col bg-opacity-80 p-4 gap-2 overflow-y-scroll scroll-smooth flex-auto",
  ref: "chatWindow"
};
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_chat_message = __unplugin_components_0$1;
...
_sfc_main$1.__file = "src/chat/ChatMessages.vue";
var __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", render$1], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/chat/ChatMessages.vue"]]);
const _hoisted_1 = {
  class: "flex flex-col overflow-y-scroll",
  style: { "flex": "1000 1 auto" }
};
const _hoisted_2 = { class: "px-4 py-6 flex flex-wrap items-center text-center" };
const _hoisted_3 = { class: "flex-1 ml-2 font-bold" };
const _hoisted_4 = { class: "p-4 bg-dark-50 bg-opacity-80 flex gap-2 flex sticky bottom-0" };
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_chat_messages = __unplugin_components_0;
  const _component_chat_input = __unplugin_components_1;
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("div", _hoisted_2, [
      createBaseVNode("div", _hoisted_3, toDisplayString($setup.currentChat), 1)
    ]),
...
_sfc_main.__file = "src/chat/ChatRoom.vue";
var ChatRoom = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/chat/ChatRoom.vue"]]);
