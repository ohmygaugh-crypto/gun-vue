...
import { resolveComponent, openBlock, createBlock, withCtx, createBaseVNode, withDirectives, vModelText, createVNode, normalizeProps, guardReactiveProps, defineAsyncComponent, reactive, onMounted } from "./vendor.es.js";
...
const _sfc_main = {
  ...
  setup(__props, { expose }) {
    ...
    async function generate() {
      const { SEA } = await __vitePreload(() => import("./index.es.js"), true ? ["index.es.js","useDict.es.js","vendor.es.js"] : void 0);
