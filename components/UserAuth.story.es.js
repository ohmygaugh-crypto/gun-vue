  ...
  return openBlock(), createBlock(_component_Story, {
    ...
    default: withCtx(() => [
      createVNode(_component_Variant, { title: "Round" }, {
        default: withCtx(() => [
          createVNode($setup["UserAuth"], normalizeProps(guardReactiveProps($setup.state)), null, 16)
        ]),
        _: 1
      })
    ]),
...
const _sfc_main = {
  ...
  setup(__props, { expose }) {
    expose();
    const UserAuth = defineAsyncComponent(() => __vitePreload(() => import("./UserAuth.es.js").then(function(n) {
      return n.UserAuth;
    }), true ? ["UserAuth.es.js","useDraw.es.js","vendor.es.js","useFile.es.js","plugin-vue_export-helper.es.js"] : void 0));
    ...
    const __returned__ = { UserAuth, state, generate, defineAsyncComponent, reactive };
