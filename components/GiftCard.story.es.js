...
import { resolveComponent, openBlock, createBlock, withCtx, createBaseVNode, withDirectives, vModelText, createVNode, defineAsyncComponent, reactive, ref, onMounted, watch, watchEffect, computedAsync } from "./vendor.es.js";
...
const _sfc_main = {
  ...
  setup(__props, { expose }) {
    expose();
    const GiftCard = defineAsyncComponent(() => __vitePreload(() => import("./GiftCard.es.js"), true ? ["GiftCard.es.js","useDict.es.js","vendor.es.js","useGifts.es.js","AccountAvatar.es.js","plugin-vue_export-helper.es.js"] : void 0));
    const gift = reactive({
      from: "",
      to: "",
      qn: 0,
    ...
    watch(gift, async () => {
      const { hashObj } = await __vitePreload(() => import("./index.es.js"), true ? ["index.es.js","useDict.es.js","vendor.es.js","useGifts.es.js"] : void 0);
      hashed.value = await hashObj(gift);
    });
    const __returned__ = { GiftCard, gift, hashed, state, generate, defineAsyncComponent, onMounted, reactive, ref, watch, watchEffect, computedAsync };
...
//# sourceMappingURL=GiftCard.story.es.js.map
