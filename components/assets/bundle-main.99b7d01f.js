import { defineStore, defineComponent, ref, computed, watch, useTitle, onMounted, resolveComponent, openBlock, createElementBlock, unref, createVNode, _sfc_main as _sfc_main$b, createCommentVNode, createBaseVNode, createBlock, withCtx, normalizeStyle, Transition, Fragment, createApp, createPinia, plugin, useStorage, renderList, useEventListener, resolveDirective, withDirectives, Icon, defineAsyncComponent, vShow, withKeys, normalizeClass, toDisplayString, isRef, useCssVars, createTextVNode, reactive, useRoute, pushScopeId, popScopeId } from "../vendor.es.js";
import { files, mapFile, isDark, histoireConfig, toggleDark, __vitePreload, tree, customLogos } from "../mapping.es.js";
import { isMobile, BaseSplitPane, _export_sfc, _sfc_main as _sfc_main$c, useScrollOnActive, BaseListItemLink } from "../MobileOverlay.es.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const SearchPane = defineAsyncComponent({
      loader: () => __vitePreload(() => import("../SearchPane.es.js"), true ? ["SearchPane.es.js","mapping.es.js","vendor.es.js","story.es.js","BaseEmpty.es.js","MobileOverlay.es.js"] : void 0),
