import { defineStore, defineComponent, ref, computed, watch, useTitle, onMounted, resolveComponent, openBlock, createElementBlock, unref, createVNode, _sfc_main as _sfc_main$b, createCommentVNode, createBaseVNode, createBlock, withCtx, normalizeStyle, Transition, Fragment, createApp, createPinia, plugin, useStorage, renderList, useEventListener, resolveDirective, withDirectives, Icon, defineAsyncComponent, __vitePreload, vShow, withKeys, normalizeClass, toDisplayString, isRef, useCssVars, createTextVNode, reactive, useRoute, pushScopeId, popScopeId } from "../vendor.es.js";
import { files, mapFile, isDark, histoireConfig, toggleDark, tree, customLogos } from "../mapping.es.js";
