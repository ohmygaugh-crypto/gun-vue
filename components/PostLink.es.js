import { openBlock, createElementBlock, createBaseVNode, toDisplayString, createVNode, createCommentVNode, ref, computed, reactive } from "./vendor.es.js";
...
var __unplugin_components_0$1 = { name: "la-external-link-alt", render: render$4 };
...
_sfc_main$1.__file = "src/ui/UiLink.vue";
var __unplugin_components_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", render$3], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/ui/UiLink.vue"]]);
const _hoisted_1$2 = {
  preserveAspectRatio: "xMidYMid meet",
  viewBox: "0 0 24 24",
  width: "1.2em",
...
var __unplugin_components_2 = { name: "mdi-text-long", render: render$2 };
const _hoisted_1$1 = {
  preserveAspectRatio: "xMidYMid meet",
  viewBox: "0 0 32 32",
  width: "1.2em",
...
var __unplugin_components_1 = { name: "la-youtube", render: render$1 };
const _hoisted_1 = {
  key: 0,
  class: "m-1 flex items-center items-center px-2 py-1 bg-light-700 dark_bg-dark-50 rounded-lg"
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.count > 0 ? (openBlock(), createElementBlock("button", _hoisted_1, toDisplayString($setup.count), 1)) : createCommentVNode("v-if", true);
}
const _sfc_main = {
  __name: "PostLink",
  props: {
...
_sfc_main.__file = "src/post/PostLink.vue";
var __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/post/PostLink.vue"]]);
export { __unplugin_components_0, __unplugin_components_1, __unplugin_components_2, __unplugin_components_3 };
