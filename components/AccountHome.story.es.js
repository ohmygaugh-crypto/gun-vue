...
import { resolveComponent, openBlock, createBlock, withCtx, createBaseVNode, createVNode, defineAsyncComponent, reactive, onMounted, watchOnce, computed } from "./vendor.es.js";
...
const _sfc_main = {
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { AccountHome, AccountSelect, state, computed, defineAsyncComponent, onMounted, reactive, watchOnce };
